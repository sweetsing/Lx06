...
namespace DAL
{
    public class Comment
    {
        ...
        public Model.Comment GetModel(string id)
        {
        ...
        public int Add(Model.Comment comment)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "insert into Comment values(commentID,workId,userName,CommentContent,CommentTime)"+"value(@commentID,@workId,@userName,@CommentConent,@CommentTime);";
                sql += "SELECT @@IDENTITY";
        ...
        public int Delete(int id)
        {
            using (IDbConnection cn = new MySqlConnection(cns))
            {
                string sql = "delete from userinfo where commentId=@id";
